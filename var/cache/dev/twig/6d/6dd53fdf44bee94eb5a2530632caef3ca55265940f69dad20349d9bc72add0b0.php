...
class __TwigTemplate_c7de5d11a332ce58c53a8a6f90a6deace8990bfaf1c4936e3a6e6fd3df74ec7f extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        <tbody>
            <tr>
                ...
                <td>";
        // line 12
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["critere_surveille"]) || array_key_exists("critere_surveille", $context) ? $context["critere_surveille"] : (function () { throw new RuntimeError('Variable "critere_surveille" does not exist.', 12, $this->source); })()), "id", [], "any", false, false, false, 12), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Critere</th>
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["critere_surveille"]) || array_key_exists("critere_surveille", $context) ? $context["critere_surveille"] : (function () { throw new RuntimeError('Variable "critere_surveille" does not exist.', 16, $this->source); })()), "critere", [], "any", false, false, false, 16), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <a href=\"";
        // line 23
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("critere_surveille_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["critere_surveille"]) || array_key_exists("critere_surveille", $context) ? $context["critere_surveille"] : (function () { throw new RuntimeError('Variable "critere_surveille" does not exist.', 23, $this->source); })()), "id", [], "any", false, false, false, 23)]), "html", null, true);
        echo "\">edit</a>
...
{% block title %}CritereSurveille{% endblock %}

{% block body %}
    <h1>CritereSurveille</h1>
...
{% endblock %}
", "critere_surveille/show.html.twig", "/home/roland/Bureau/audit/templates/critere_surveille/show.html.twig");
    }
}
