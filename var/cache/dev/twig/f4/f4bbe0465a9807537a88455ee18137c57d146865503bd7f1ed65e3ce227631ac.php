...
class __TwigTemplate_e4d9b7aeb3a7aaeefa7558e93194bf41de51453801e47e8ae0a36fdaf7dac9ba extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Create new MatiereUtiliser</h1>

    ";
        // line 8
        echo twig_include($this->env, $context, "matiere_utiliser/_form.html.twig");
        echo "
...
{% block title %}New MatiereUtiliser{% endblock %}

{% block body %}
    <h1>Create new MatiereUtiliser</h1>

    {{ include('matiere_utiliser/_form.html.twig') }}

    <a href=\"{{ path('matiere_utiliser_index') }}\">back to list</a>
{% endblock %}
", "matiere_utiliser/new.html.twig", "/home/roland/Bureau/audit/templates/matiere_utiliser/new.html.twig");
    }
}
