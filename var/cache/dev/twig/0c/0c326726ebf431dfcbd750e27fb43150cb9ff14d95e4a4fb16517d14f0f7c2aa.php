...
class __TwigTemplate_ea1078484c68b6d9b0d9d42c6f9cca403766249df2c760fb990687938bc88d1f extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Create new TypeProbleme</h1>
...
{% block title %}New TypeProbleme{% endblock %}

{% block body %}
    <h1>Create new TypeProbleme</h1>

    {{ include('type_probleme/_form.html.twig') }}

    <a href=\"{{ path('type_probleme_index') }}\">back to list</a>
{% endblock %}
", "type_probleme/new.html.twig", "/home/roland/Bureau/audit/templates/type_probleme/new.html.twig");
    }
}
